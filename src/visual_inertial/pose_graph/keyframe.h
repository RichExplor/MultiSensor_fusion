...
#include "../feature_tracker/camera_models/CameraFactory.h"
#include "../feature_tracker/camera_models/CataCamera.h"
#include "../feature_tracker/camera_models/PinholeCamera.h"
